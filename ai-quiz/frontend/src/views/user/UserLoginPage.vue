  ...
  <div class="login-page">
    ...
    <div class="login-container">
      <div class="login-brand">
        ...
        <h1>AI 智能答题</h1>
        <p>AI 驱动的智能出题、评分与统计分析平台</p>
        <div class="brand-features">
          <div class="feature-dot"><icon-check-circle /> AI 自动生成题目</div>
          <div class="feature-dot"><icon-check-circle /> 多策略智能评分</div>
          <div class="feature-dot"><icon-check-circle /> 答题结果统计分析</div>
        </div>
      </div>
      <div class="login-card">
        ...
        >
          ...
          <div class="card-footer">
            还没有账号？<a-link @click="$router.push('/user/register')">立即注册</a-link>
          </div>
        </a-form>
      </div>
    </div>
