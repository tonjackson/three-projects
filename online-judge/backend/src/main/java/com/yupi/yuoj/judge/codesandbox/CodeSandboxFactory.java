...
public class CodeSandboxFactory {
    ...
    private static String authHeader = "auth";
    private static String authSecret = "secretKey";

    public static void setAuthConfig(String header, String secret) {
        authHeader = header;
        authSecret = secret;
    }
    ...
    public static CodeSandbox newInstance(String type) {
        switch (type) {
            ...
            case "remote":
                ...
                remoteCodeSandbox.setAuthConfig(authHeader, authSecret);
